...
export const metadata: Metadata = { title: "Ментор" };
  ...
  return (
    <div className="container-page space-y-6 py-6 sm:py-10">
      <PageHeader
        ...
        description="Ментор — студент или выпускник, который уже прошёл путь поступления. Он видит твою анкету, подборку и маршрут и отвечает в чате."
        actions={
          <Link href="/mentor/apply" className="inline-flex h-9 items-center rounded-xl px-3 text-sm font-semibold text-brand-700 ring-1 ring-brand-100 hover:bg-brand-50">
            Стать ментором
          </Link>
        }
      />
