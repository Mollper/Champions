...
export default async function PlannerPage() {
  ...
  return (
    <div className="container-page space-y-6 py-6 sm:py-10">
      <PageHeader
        eyebrow="ИИ-планировщик"
        title="Планы подготовки"
        description="Юни составит план по неделям — с учётом твоей анкеты, выбранных вузов и дедлайнов. Отмечай задачи: прогресс сохраняется."
      />
