...
const STYLE_RULES: Record<AssistantStyle, string> = {
  ...
  mentor: "Тон — ментор: спокойно объясняй причины и давай нумерованный план из 3–5 шагов. 120–220 слов.",
  strict: "Тон — строгий коуч: коротко, по фактам, без утешений, с конкретными сроками и требованиями. 60–140 слов.",
  concise: "Максимально кратко: 1–2 предложения сути и одно главное действие. До 50 слов.",
};
